%module m8fb67ea908d11788d30be737988028d6
...
%{
#include "/home/caci114/Project_2023/SIM_submarine/S_source.hh"
%}
...
%import "build/home/caci114/Project_2023/SIM_submarine/models/submarine/include/Submarine_py.i"
...
class SubmarineSimObject : public Trick::SimObject {
    ...
    SubmarineSimObject() {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "initalization", NULL, 1, "submarine.submarine_init", "", 60000) ;
            ...
            job = this->add_job(0, 4, "scheduled", NULL, 0.1, "submarine.submarine_control", "", 60000) ;
            job = this->add_job(0, 5, "shutdown", NULL, 1, "submarine.submarine_shutdown", "", 60000) ;
    }
