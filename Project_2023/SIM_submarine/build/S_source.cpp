...
/* Created 2023/12/12 11:46:13 caci114 $ */
#include "../S_source.hh"
...
int SubmarineSimObject::call_function ( Trick::JobData * curr_job ) {
    ...
    switch ( curr_job->id ) {
        case 0:
            submarine.submarine_init() ;
            break ;
        case 1:
            submarine.submarine_default_data() ;
            break ;
        case 2:
            submarine.submarine_deriv() ;
            break ;
        case 3:
            trick_ret = submarine.submarine_integ() ;
            break ;
        case 4:
            submarine.submarine_control() ;
            break ;
        case 5:
            submarine.submarine_shutdown() ;
            break ;
        default:
            trick_ret = -1 ;
            break ;
...
double SubmarineSimObject::call_function_double ( Trick::JobData * curr_job ) {
...
SimEnvironment::SimEnvironment() {
    ...
    local_env["TRICK_CC"] = "/usr/lib64/ccache/gcc";
    ...
    local_env["TRICK_CXX"] = "/usr/lib64/ccache/g++";
    ...
    local_env["TRICK_EXEC_LINK_LIBS"] = "-lpthread -lpthread -ldl -lutil -lm -lpython2.7 -Xlinker -export-dynamic -lpthread -ldl -lutil -lm -lpython2.7   -ludunits2 -lrt -lm -ldl -lhdf5_hl -lhdf5 -lgsl -lgslcblas";
    ...
    local_env["TRICK_HOME"] = "/home/caci114/trick";
    setenv("TRICK_HOME", local_env["TRICK_HOME"].c_str(), 0);
    local_env["TRICK_HOST_CPU"] = "Linux_4.8_x86_64";
    ...
    local_env["TRICK_PATH"] = "/home/caci114/trick/libexec/bin";
    ...
    local_env["TRICK_SYSTEM_CFLAGS"] = "-isystem/home/caci114/trick/trick_source -isystem/home/caci114/trick/include -isystem/home/caci114/trick/include/trick/compat -DTRICK_VER=19 -DTRICK_MINOR=6 -fpic -I/usr/include/udunits2 -DUSE_ER7_UTILS_INTEGRATORS -D_HAVE_GSL -fexceptions ";
    setenv("TRICK_SYSTEM_CFLAGS", local_env["TRICK_SYSTEM_CFLAGS"].c_str(), 0);
    local_env["TRICK_SYSTEM_CXXFLAGS"] = "-isystem/home/caci114/trick/trick_source -isystem/home/caci114/trick/include -isystem/home/caci114/trick/include/trick/compat -DTRICK_VER=19 -DTRICK_MINOR=6 -fpic -I/usr/include/udunits2 -DUSE_ER7_UTILS_INTEGRATORS -D_HAVE_GSL ";
    ...
    local_env["TRICK_USER_CSHRC"] = "/home/caci114/.Trick_user_cshrc";
    setenv("TRICK_USER_CSHRC", local_env["TRICK_USER_CSHRC"].c_str(), 0);
    local_env["TRICK_USER_HOME"] = "/home/caci114/trick_sims";
    ...
    local_env["TRICK_USER_PROFILE"] = "/home/caci114/.Trick_user_profile";
    ...
    local_env["XML_CATALOG_FILES"] = "/home/caci114/trick/libexec/trick_source/data_products/DPX/XML/catalog.xml";
...
void memory_init( void ) {
    ...
    ALLOC_INFO * ai ;
    exec_set_version_date_tag( "@(#)CP Version 19.6.0-beta, Tue Dec 12 11:46:13 2023" ) ;
    exec_set_build_date( "Tue Dec 12 11:46:13 2023" ) ;
    ...
    TMM_declare_ext_var(&dyn, TRICK_STRUCTURED,"SubmarineSimObject", 0, "dyn", 0, NULL) ;
